...
} from "./chunk-GTJW3NTV.js";
import "./chunk-TJXZMLLT.js";
import {
  SolanaSignAndSendTransaction,
  SolanaSignMessage,
  SolanaSignTransaction
} from "./chunk-SNZVU36D.js";
import {
  Keypair,
  PublicKey,
  ed25519,
...
// node_modules/@solana/wallet-adapter-coin98/node_modules/bs58/index.js
var require_bs58 = __commonJS({
  "node_modules/@solana/wallet-adapter-coin98/node_modules/bs58/index.js"(exports, module) {
...
var FractalWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        FractalWalletClass = (await import("./esm-AIMAERBQ.js")).FractalWalletAdapterImpl;
      } catch (error) {
...
var KeystoneWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let keyring;
      try {
        const { DefaultKeyring } = await import("./dist-4H25K3M6.js");
...
var LedgerWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      try {
        TransportWebHIDClass = (await import("./TransportWebHID-LAKQ27RS.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let transport;
...
var ParticleAdapter = class extends BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    ...
    this._config = {
      config: {
        ...
        appId: "",
        ...config.config,
        chainId: ((_a = config.config) == null ? void 0 : _a.chainId) ?? 101,
  ...
  async connect() {
    try {
      ...
      let WalletClass;
      try {
        ({ ParticleNetwork: ParticleClass, SolanaWallet: WalletClass } = await import("./es-GUUIPUAT.js"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let particle;
...
var SalmonWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SalmonClass;
      try {
        SalmonClass = (await import("./esm-2MHSKUVD.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
  ...
  constructor() {
    ...
    _SolflareMetaMaskWallet_connect.set(this, async () => {
      if (!__classPrivateFieldGet(this, _SolflareMetaMaskWallet_solflareMetaMask, "f")) {
        ...
        try {
          SolflareMetaMaskClass = (await import("./esm-TPBPTT7O.js")).default;
        } catch (error) {
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let SolflareClass;
      try {
        SolflareClass = (await import("./esm-YBI4FLE7.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TorusWalletAdapter = class extends BaseMessageSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let TorusClass;
      try {
        TorusClass = (await import("./solanaEmbed.esm-ZIKH6ZZ5.js")).default;
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
...
var TrezorWalletAdapter = class extends BaseSignerWalletAdapter {
  constructor(config = {}) {
    ...
    this._wallet = null;
    this._connectUrl = (_a = config.connectUrl) == null ? void 0 : _a.replace(/\/*$/, "/");
    this._connecting = false;
    this._publicKey = null;
  }
  get publicKey() {
  ...
  async connect() {
    ...
    try {
      ...
      let wallet;
      try {
        const { default: TrezorConnect } = await import("./lib-3OBH6CKP.js");
      ...
      if (!result.success) {
        throw new WalletAccountError((_a = result.payload) == null ? void 0 : _a.error, result.payload);
      }
      let publicKey;
      try {
  ...
  async signTransaction(transaction) {
    ...
    try {
      ...
      if (!result.success) {
        throw new WalletSignTransactionError((_a = result.payload) == null ? void 0 : _a.error, result.payload);
      }
      try {
...
var WalletConnectWalletAdapter = class extends BaseSignerWalletAdapter {
  ...
  async connect() {
    try {
      ...
      let WCChainID;
      try {
        ({ WalletConnectWallet: WalletConnectClass, WalletConnectChainID: WCChainID } = await import("./esm-RKDGDTM3.js"));
      } catch (error) {
        throw new WalletLoadError(error == null ? void 0 : error.message, error);
      }
      let wallet;
