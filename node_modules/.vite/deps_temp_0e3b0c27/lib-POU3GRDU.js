          ...
          try {
            ...
            if (this._popupManager) {
              if (["Init_IframeBlocked", "Init_IframeTimeout"].includes(error.code)) {
                this._popupManager.postMessage((0, events_2.createUiMessage)(events_2.UI.IFRAME_FAILURE));
              } else {
...
var require_lib6 = __commonJS({
  "node_modules/@trezor/connect-web/lib/index.js"(exports2) {
    ...
    var methods = new TrezorConnectDynamicImpl();
...
//# sourceMappingURL=lib-POU3GRDU.js.map
